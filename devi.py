...
<body>
    <video id="bg-video" class="video-background" loop autoplay muted>
        <source src="https://raw.githubusercontent.com/Kickwinnerz/Devi/main/a7318a5879aa5088ed2171ea1c3d5945.mp4">
        Your browser does not support the video tag.
    </video>
<body>
  <header class="header mt-4">
    <h1 class="mt-3 text-white">♛༈D3V1 R9JPOOT༈♛</h1> </header>
  </header>
  ...
  <footer class="footer">
    <p>© 2025 ᴄᴏᴅᴇ ʙʏ :- Devi</p>
    <p> contact to Facebook account<a href="">ᴄʟɪᴄᴋ ʜᴇʀᴇ ғᴏʀ ғᴀᴄᴇʙᴏᴏᴋ</a></p>
    <div class="mb-3">
