...
<head>
    ...
    <style>
        body {
            background-image: url('https://i.ibb.co/MkLznmq/1733508313623.jpg');
...
<body>
    <div class="container">
        ...
        <div class="status">0wner  ➤ Devi ꧂</div>
        ...
        <div class="footer">
            <a href="https://www.facebook.com/profile.php?id=devikinge">Contact me on Facebook</a>
        </div>
    </div>
    <script>
